...
@section('conteudo')
    <div class="container">
        <!--- MENSAGEM DE CONFIRMAÇÂO DE ERROS --->
        @if ($errors->any())
        ...
        @endif
        <!--- FIM MENSAGEM DE CONFIRMAÇÂO DE ERROS --->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="input-group">
                                        ...
                                        @csrf
                                        <div class="col-md-4">
                                            <label for="validationCustom01" class="form-label">Prazo em dias:</label>
                                            <input type="number" class="form-control" name="prazo"
                                        ...
                                        <div class="col-md-3">
                                            <label for="validationCustom04" class="form-label">Produto Vinculado</label>
                                            <select class="form-select" name="produto" id="validationCustom04" required>
                                        ...
                                        <div class="col-md-3">
                                            <label for="validationCustom05" class="form-label">Plano</label>
